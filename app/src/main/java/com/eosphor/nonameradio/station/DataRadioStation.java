...
import com.eosphor.nonameradio.StationSaveManager;
...
public class DataRadioStation implements Parcelable {
	...
	public static final String RADIO_STATION_LOCAL_INFO_CHAGED = "com.eosphor.nonameradio.radiostation.changed";
