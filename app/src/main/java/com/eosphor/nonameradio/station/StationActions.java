...
import com.eosphor.nonameradio.RadioBrowserServerManager;
...
import com.eosphor.nonameradio.views.ItemListDialog;
...
public class StationActions {
    ...
    public static void openStationHomeUrl(final @NonNull FragmentActivity activity, final @NonNull DataRadioStation station) {
