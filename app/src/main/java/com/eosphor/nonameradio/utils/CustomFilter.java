package com.eosphor.nonameradio.utils;
...
/**
 * This is a copy of {@link com.eosphor.nonameradio.utils.CustomFilter} with @hide removed from delayer.
 */
public abstract class CustomFilter {
     ...
     *
     * @see #filter(CharSequence, com.eosphor.nonameradio.utils.CustomFilter.FilterListener)
     */
     ...
     * @see #publishResults(CharSequence, com.eosphor.nonameradio.utils.CustomFilter.FilterResults)
     */
    public final void filter(CharSequence constraint, com.eosphor.nonameradio.utils.CustomFilter.FilterListener listener) {
        synchronized (mLock) {
     ...
     * must be returned as a {@link com.eosphor.nonameradio.utils.CustomFilter.FilterResults} that
     * will then be published in the UI thread through
     * {@link #publishResults(CharSequence,
     * com.eosphor.nonameradio.utils.CustomFilter.FilterResults)}.</p>
     *
     ...
     * @see #filter(CharSequence, com.eosphor.nonameradio.utils.CustomFilter.FilterListener)
     * @see #publishResults(CharSequence, com.eosphor.nonameradio.utils.CustomFilter.FilterResults)
     * @see com.eosphor.nonameradio.utils.CustomFilter.FilterResults
     */
    protected abstract com.eosphor.nonameradio.utils.CustomFilter.FilterResults performFiltering(CharSequence constraint);
    ...
    protected abstract void publishResults(CharSequence constraint,
                                           com.eosphor.nonameradio.utils.CustomFilter.FilterResults results);
     ...
     * {@link com.eosphor.nonameradio.utils.CustomFilter#filter(CharSequence, com.eosphor.nonameradio.utils.CustomFilter.FilterListener)},
    ...
    private class RequestHandler extends Handler {
         ...
         * {@link com.eosphor.nonameradio.utils.CustomFilter#performFiltering} and then sending a message
            ...
            switch (what) {
                case FILTER_TOKEN:
                    ...
                    try {
                        ...
                        args.results = new com.eosphor.nonameradio.utils.CustomFilter.FilterResults();
    ...
    private class ResultsHandler extends Handler {
         ...
         * {@link com.eosphor.nonameradio.utils.CustomFilter#publishResults(CharSequence,
         * com.eosphor.nonameradio.utils.CustomFilter.FilterResults)}
    ...
    private static class RequestArguments {
         ...
         */
        com.eosphor.nonameradio.utils.CustomFilter.FilterListener listener;
    ...
    public interface Delayer {
        ...
        /**
         * @param constraint The constraint passed to {@link com.eosphor.nonameradio.utils.CustomFilter#filter(CharSequence)}
