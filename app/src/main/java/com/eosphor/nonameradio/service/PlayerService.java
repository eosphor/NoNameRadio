package com.eosphor.nonameradio.service;
...
import com.eosphor.nonameradio.players.RadioPlayer;
import com.eosphor.nonameradio.recording.RecordingsManager;
import com.eosphor.nonameradio.recording.RunningRecordingInfo;
...
public class PlayerService extends JobIntentService implements RadioPlayer.PlayerListener {
    ...
    public static final String PLAYER_SERVICE_TIMER_UPDATE = "com.eosphor.nonameradio.timerupdate";
    public static final String PLAYER_SERVICE_META_UPDATE = "com.eosphor.nonameradio.metaupdate";

    public static final String PLAYER_SERVICE_STATE_CHANGE = "com.eosphor.nonameradio.statechange";
    public static final String PLAYER_SERVICE_STATE_EXTRA_KEY = "state";

    public static final String PLAYER_SERVICE_METERED_CONNECTION = "com.eosphor.nonameradio.metered_connection";
    public static final String PLAYER_SERVICE_METERED_CONNECTION_PLAYER_TYPE = "PLAYER_TYPE";

    public static final String PLAYER_SERVICE_BOUND = "com.eosphor.nonameradio.playerservicebound";
