...
import static com.eosphor.nonameradio.Utils.getMimeType;
...
public class IcyDataSource implements HttpDataSource {
    ...
    private long connect() throws HttpDataSourceException {
        ...
        if (!response.isSuccessful()) {
            ...
            throw new InvalidResponseCodeException(responseCode, response.message(), new IOException("HTTP " + responseCode), headers, dataSpec, new byte[0]);
        }
