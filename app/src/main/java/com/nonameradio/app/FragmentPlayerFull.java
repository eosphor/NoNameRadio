...
public class FragmentPlayerFull extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // trackHistoryAdapter creation moved to onCreateView() to prevent Paging 3 double subscription crash
        // Issue: "Attempt to collect twice from pageEventFlow"

        trackHistoryRepository = app.getTrackHistoryRepository();
        
        // Use Activity-scoped ViewModel to prevent double subscription on Fragment recreation
        trackHistoryViewModel = new ViewModelProvider(requireActivity()).get(TrackHistoryViewModel.class);

        // EventBus listener will be registered in onResume()
        ...
        // Create new adapter instance on each view creation to prevent Paging 3 double subscription
        ...
        // trackHistoryViewModel already initialized in onCreate() with Activity scope
        // cachedIn() in Kotlin ViewModel prevents double subscription crash
        trackHistoryAdapter.setShouldLoadIcons(Utils.shouldLoadIcons(getContext()));
        trackHistoryViewModel.getAllHistoryPaged().observe(getViewLifecycleOwner(), pagingData -> {
            trackHistoryAdapter.submitData(getLifecycle(), pagingData);
        });
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Setup button click listeners after views are created
            ...
            if (MediaSessionUtil.isPlaying()) {
                if (MediaSessionUtil.isRecording()) {
                    ...
                    if (recordingsManager.hasRecordingPermission()) {
                        ...
                        // TODO: Migrate to registerForActivityResult API
                        @SuppressWarnings("deprecation")
                        String[] permissions = recordingsManager.getRequiredPermissions();
                        requestPermissions(permissions, PERM_REQ_STORAGE_RECORD);
                    }
                }
    ...
    private void startUpdating() {
        ...
        // Register EventBus listener for metadata updates
        ...
        // Observe favourites changes using LiveData
    ...
    private void stopUpdating() {
        ...
        // LiveData observers are automatically unregistered via getViewLifecycleOwner()
    }
