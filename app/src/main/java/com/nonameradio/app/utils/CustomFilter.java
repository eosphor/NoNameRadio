...
/**
 * This is a copy of {@link com.nonameradio.app.utils.CustomFilter} with @hide removed from delayer.
 */
public abstract class CustomFilter {
     ...
     *
     * @see #filter(CharSequence, com.nonameradio.app.utils.CustomFilter.FilterListener)
     */
     ...
     * @see #publishResults(CharSequence, com.nonameradio.app.utils.CustomFilter.FilterResults)
     */
    public final void filter(CharSequence constraint, com.nonameradio.app.utils.CustomFilter.FilterListener listener) {
        synchronized (mLock) {
     ...
     * must be returned as a {@link com.nonameradio.app.utils.CustomFilter.FilterResults} that
     * will then be published in the UI thread through
     * {@link #publishResults(CharSequence,
     * com.nonameradio.app.utils.CustomFilter.FilterResults)}.</p>
     *
     ...
     * @see #filter(CharSequence, com.nonameradio.app.utils.CustomFilter.FilterListener)
     * @see #publishResults(CharSequence, com.nonameradio.app.utils.CustomFilter.FilterResults)
     * @see com.nonameradio.app.utils.CustomFilter.FilterResults
     */
    protected abstract com.nonameradio.app.utils.CustomFilter.FilterResults performFiltering(CharSequence constraint);
    ...
    protected abstract void publishResults(CharSequence constraint,
                                           com.nonameradio.app.utils.CustomFilter.FilterResults results);
     ...
     * {@link com.nonameradio.app.utils.CustomFilter#filter(CharSequence, com.nonameradio.app.utils.CustomFilter.FilterListener)},
    ...
    private class RequestHandler extends Handler {
         ...
         * {@link com.nonameradio.app.utils.CustomFilter#performFiltering} and then sending a message
            ...
            switch (what) {
                case FILTER_TOKEN:
                    ...
                    try {
                        ...
                        args.results = new com.nonameradio.app.utils.CustomFilter.FilterResults();
    ...
    private class ResultsHandler extends Handler {
         ...
         * {@link com.nonameradio.app.utils.CustomFilter#publishResults(CharSequence,
         * com.nonameradio.app.utils.CustomFilter.FilterResults)}
    ...
    private static class RequestArguments {
         ...
         */
        com.nonameradio.app.utils.CustomFilter.FilterListener listener;
    ...
    public interface Delayer {
        ...
        /**
         * @param constraint The constraint passed to {@link com.nonameradio.app.utils.CustomFilter#filter(CharSequence)}
