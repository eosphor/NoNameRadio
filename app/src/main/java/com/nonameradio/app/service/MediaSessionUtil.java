...
public class MediaSessionUtil {
    ...
    public static boolean isPlaying() {
        if (mediaControllerHelper != null) {
            boolean result = mediaControllerHelper.isPlaying();
            Log.d(TAG, "MediaSessionUtil.isPlaying() -> " + result);
            return result;
        } else {
            Log.e(TAG, "MediaSessionUtil not initialized - isPlaying, returning false");
            return false;
        }
    }
    ...
    public static boolean isRecording() {
        if (mediaControllerHelper != null) {
            NoNameRadioApp app = (NoNameRadioApp) mediaControllerHelper.getContext();
    ...
    public static void startService(Context context) {
        ...
        // Start RadioMediaSessionService to ensure it's running
        Intent serviceIntent = new Intent(context, RadioMediaSessionService.class);
        try {
            context.startService(serviceIntent);
            Log.d(TAG, "Started RadioMediaSessionService");
        } catch (Exception e) {
            Log.e(TAG, "Failed to start RadioMediaSessionService", e);
        }
    }
     ...
     */
    public static void pause(com.nonameradio.app.service.PauseReason pauseReason) {
        pause();
    }
     ...
     */
    public static com.nonameradio.app.service.PauseReason getPauseReason() {
        // Pause reason not tracked in MediaSession
        return com.nonameradio.app.service.PauseReason.USER;
    }
