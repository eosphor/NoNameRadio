...
public class PlayerServiceUtil {
    ...
    /**
     * Application Context (not Activity Context) to prevent memory leaks.
     * Always use getApplicationContext() when setting this field.
     */
    ...
    private static ServiceConnection getServiceConnection() {
        return new ServiceConnection() {
            public void onServiceConnected(ComponentName className, IBinder binder) {
                ...
                // Notify that PlayerService is bound and ready via EventBus
                EventBus.post(PlayerServiceBoundEvent.INSTANCE);
            }
