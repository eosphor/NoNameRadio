...
import com.nonameradio.app.core.event.MediaSessionUpdateEvent;
...
public class MediaSessionCallback extends MediaSessionCompat.Callback {
    ...
    public boolean onMediaButtonEvent(Intent mediaButtonEvent) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.TIRAMISU) {
            event = mediaButtonEvent.getParcelableExtra(Intent.EXTRA_KEY_EVENT, KeyEvent.class);
        } else {
            event = (KeyEvent) mediaButtonEvent.getParcelableExtra(Intent.EXTRA_KEY_EVENT);
        }
    ...
    public void onPlayFromMediaId(String mediaId, Bundle extras) {
        ...
        if (!stationId.isEmpty()) {
            ...
            EventBus.post(new MediaSessionUpdateEvent(stationId));
        }
    }
