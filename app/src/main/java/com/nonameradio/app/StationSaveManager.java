...
public class StationSaveManager extends Observable {
    ...
    public StationSaveManager(Context ctx) {
        ...
        // Set up legacy Observable compatibility
        setupLegacyObserver();
    }
    ...
    private void setupLegacyObserver() {
        // Bridge LiveData to Observable for backward compatibility
        stationManager.getStationsLiveData().observeForever(stations -> {
            setChanged();
            notifyObservers();
        });
    }
