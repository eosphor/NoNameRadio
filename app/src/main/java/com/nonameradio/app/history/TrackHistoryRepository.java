...
import static com.nonameradio.app.history.TrackHistoryEntry.MAX_HISTORY_ITEMS_IN_TABLE;
...
public class TrackHistoryRepository {
    ...
    public TrackHistoryRepository(Application application) {
        NoNameRadioDatabase db = NoNameRadioDatabase.getDatabase(application);
