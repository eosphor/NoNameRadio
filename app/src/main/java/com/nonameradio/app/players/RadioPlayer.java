...
import com.nonameradio.app.players.exoplayer.ExoPlayerWrapper;
...
public class RadioPlayer implements PlayerWrapper.PlayListener, Recordable {
    ...
    public final void play(final DataRadioStation station, final boolean isAlarm) {
        ...
        if (BuildConfig.DEBUG) {
            Log.d(TAG, "play() - currentStation set to: " + (station != null ? station.Name : "null"));
        }
    ...
    public DataRadioStation getCurrentStation() {
        if (BuildConfig.DEBUG) {
            Log.d(TAG, "getCurrentStation() -> " + (currentStation != null ? currentStation.Name : "null"));
        }
        return currentStation;
    }

    public com.nonameradio.app.station.live.ShoutcastInfo getShoutcastInfo() {
        // For now, return null - this can be implemented later if needed
        return null;
    }

    public com.nonameradio.app.station.live.StreamLiveInfo getStreamLiveInfo() {
        return lastLiveInfo;
    }
