...
public class MenuHandler {
    ...
    public void updateMenuVisibility() {
        ...
        // Show sleep timer except on Alarm screen (leave space for alarm button)
    ...
    public boolean handleMenuItemClick(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_save:
                ...
                boolean hasSavePermission = Utils.verifyStoragePermissions(activity, ActivityMain.PERM_REQ_STORAGE_FAV_SAVE);
            ...
            case R.id.action_load:
                // TODO: Migrate to SAF (Storage Access Framework)
                @SuppressWarnings("deprecation")
                boolean hasLoadPermission = Utils.verifyStoragePermissions(activity, ActivityMain.PERM_REQ_STORAGE_FAV_LOAD);
